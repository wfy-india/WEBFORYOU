    ...
    <main className="pt-32 pb-24 px-6">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="prose prose-slate dark:prose-invert max-w-none space-y-8 text-muted-foreground leading-relaxed">
          ...
          <p>
            Welcome to WebForYou. By accessing or using our website and services, you agree to comply with and be bound by the following Terms & Conditions. Please read them carefully.
          </p>
          ...
          <section>
            ...
            <p className="font-bold text-foreground"><a href=" https://www.wfy.co.in/contact">CLICK AND CONTACT US!</a></p>
          </section>
        </div>
      </div>
    </main>
