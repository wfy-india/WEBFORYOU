            ...
            >
                ...
                >
                    <div className="text-center">
                        <p className="text-[8px] font-bold text-blue-400 uppercase tracking-widest mb-1">Web</p>
...
export default function ScrollMorphHero() {
    ...
    const rawScrollValue = useTransform(scrollYProgress, [0, 1], [0, MAX_SCROLL]);
    ...
    const morphProgress = useTransform(rawScrollValue, [0, 600], [0, 1]);
    const smoothMorph = useSpring(morphProgress, { stiffness: 40, damping: 20 });

    const scrollRotate = useTransform(rawScrollValue, [600, 3000], [0, 360]);
    ...
    return (
        <div ref={containerRef} className="relative w-full h-[200vh]">
            <div className="sticky top-0 flex h-screen w-full flex-col items-center justify-center perspective-1000 overflow-hidden">
                ...
                >
                    ...
                    <p className="text-sm md:text-base text-muted-foreground max-w-lg leading-relaxed">
                        Discover how we merge cutting-edge technology with creative design to build award-winning websites.
                    </p>
                </motion.div>
